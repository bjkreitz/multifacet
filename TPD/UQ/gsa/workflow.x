...
head -n18000 input.txt > ptrain.dat
tail -n1387 input.txt > pval.dat
awk 'NR<=18000{print log($1)}' output_temp_co2_max.txt > ytrain.dat
awk 'NR>18000{print log($1)}' output_temp_co2_max.txt > yval.dat
